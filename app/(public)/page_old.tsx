...
export default function HomePage() {
  ...
  useEffect(() => {
    // Use a flag to prevent unnecessary re-renders
    let isMounted = true;
  ...
  return (
    <div className="bg-cream">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* Content */}
        <div className="container-custom relative z-10 text-center py-16 sm:py-20 md:py-32 animate-fade-in-up">
          <div className="max-w-5xl mx-auto">
            {/* Luxury Badge */}
            <div className="inline-block mb-6 sm:mb-8 px-4 sm:px-6 py-2 bg-accent border-2 border-white rounded-full">
              <span className="text-xs sm:text-sm tracking-[0.3em] uppercase text-white font-medium">
                Est. Since 2005 • Licensed & Certified
              </span>
            </div>

            <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl mb-8 text-cream tracking-tight leading-[0.9]">
              MĒL<span className="inline-block">11</span>
            </h1>

            <div className="mb-6">
              <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-cream/90 mb-3 font-light tracking-wide">
                In-home luxury skin + aesthetics
              </p>
              <div className="luxury-divider max-w-md mx-auto mb-6" />
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl gradient-text font-serif italic">
                Beauty. Brought to you.
              </p>
            </div>

            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-cream/80 max-w-2xl mx-auto mb-8 md:mb-12 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
              ...
              <Link href="/services">
                <button className="elegant-underline text-cream text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4">
                  Explore Services
                </button>
              </Link>
            </div>
            ...
            {/* Trust Indicators */}
            <div className="mt-8 md:mt-16 flex flex-col sm:flex-row flex-wrap justify-center gap-4 sm:gap-8 text-cream/70 text-xs sm:text-sm">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block mb-6 px-6 py-2 border border-softLine rounded-full">
              ...
              <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-8 leading-tight text-nearBlack">
              Studio-level care,<br />in your sanctuary
            </h2>

            <div className="luxury-divider max-w-xs mx-auto mb-12" />

            <div className="grid md:grid-cols-3 gap-6 md:gap-12 text-left">
      ...
      <section className="py-10 md:py-20 bg-gradient-to-b from-white to-cream relative z-20">
        <div className="container-custom">
          <div className="text-center mb-8 md:mb-20">
            ...
            <h3 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-6 text-nearBlack">
              Curated for excellence
            </h3>

            <p className="text-base sm:text-lg md:text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="py-10 md:py-20 bg-gradient-to-br from-nearBlack to-accent/90 text-cream relative z-20">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-4 text-white">
              The MĒL11 Signature Transformation
            </h2>

            <p className="text-lg sm:text-xl text-cream/90 mb-6 md:mb-8">
              8–12 week private rejuvenation program<br />
              Starting at $899
            </p>

            <p className="text-base sm:text-lg text-cream/80 mb-8 md:mb-12 max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="py-10 md:py-20 bg-white relative z-20">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-16 max-w-6xl mx-auto">
            <div className="text-center group">
              ...
              <h4 className="font-serif text-2xl md:text-3xl mb-4 text-nearBlack">Select</h4>
            ...
            <div className="text-center group">
              ...
              <h4 className="font-serif text-2xl md:text-3xl mb-4 text-nearBlack">Schedule</h4>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            ...
            <div className="text-center group">
              ...
              <h4 className="font-serif text-2xl md:text-3xl mb-4 text-nearBlack">Experience</h4>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
