          ...
          <div>
            ...
            <div className="flex gap-4 mt-6">
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-cream/10 hover:bg-accent/80 flex items-center justify-center transition-all duration-300 group"
                aria-label="Instagram"
              >
                <svg className="w-5 h-5 text-cream/80 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* TikTok */}
              <a
                href="https://tiktok.com/@mel11skin"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-cream/10 hover:bg-accent/80 flex items-center justify-center transition-all duration-300 group"
                aria-label="TikTok"
              ...
              {/* LinkedIn */}
              <a
                href="https://linkedin.com/in/mel11skin"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-cream/10 hover:bg-accent/80 flex items-center justify-center transition-all duration-300 group"
                aria-label="LinkedIn"
              ...
              {/* YouTube (not clickable) */}
              <div
                className="w-10 h-10 rounded-full bg-cream/5 flex items-center justify-center cursor-default"
                aria-label="YouTube (Coming Soon)"
                title="Coming Soon"
              >
                <svg className="w-5 h-5 text-cream/40" fill="currentColor" viewBox="0 0 24 24">
